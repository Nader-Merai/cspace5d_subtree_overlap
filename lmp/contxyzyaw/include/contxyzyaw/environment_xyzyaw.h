...
// modes
#define ORIGINAL 0
#define SUBTREE_LABELER 1
#define SUBTREE_HASH 2


// label discretization
#define OVERLAP_RADIUS 0.0005
#define COORD_DISC 0.00001
#define YAW_DISC 0.157 
#define VXY_DISC 0.0075
...
protected:
    ...
    virtual void GetSuccsNoHash(std::vector<double> sourceState, std::vector<std::vector<double>> & SuccStates);
    virtual double SubtreeOverlapNewRatio(std::vector<double> first_state, std::vector<double> second_state);
    virtual void BuildHashTable();
